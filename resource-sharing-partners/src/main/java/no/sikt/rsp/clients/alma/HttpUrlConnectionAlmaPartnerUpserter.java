package no.sikt.rsp.clients.alma;
...
public class HttpUrlConnectionAlmaPartnerUpserter extends AbstractHttpUrlConnectionApi implements AlmaPartnerUpserter {
    ...
    private static class AlmaErrorList {

        private List<AlmaError> error;

        public List<AlmaError> getError() {
            return error;
        }

        public void setError(List<AlmaError> error) {
            this.error = error;
        }
    }

    private static class AlmaErrorResponse {
