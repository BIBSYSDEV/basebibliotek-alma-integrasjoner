...
public class RecordSpecification {
    ...
    public RecordSpecification(boolean withLandkode, String nncipUri, boolean withStengtFra,
    ...
    public RecordSpecification(boolean withLandkode, String nncipUri, boolean withStengtFra,
                               boolean withStengtTil, boolean withPaddr, boolean withVaddr, boolean withIsil,
                               String katsys) {
        this(withLandkode, nncipUri, withStengtFra, withStengtTil, withPaddr, withVaddr, withIsil, katsys,
