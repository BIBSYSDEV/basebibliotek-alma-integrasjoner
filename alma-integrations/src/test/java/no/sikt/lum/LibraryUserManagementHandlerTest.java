...
class LibraryUserManagementHandlerTest {
    ...
    public void shouldLogExceptionWhenS3ClientFails() {
        ...
        libraryUserManagementHandler = new LibraryUserManagementHandler(s3Client,
                                                                        mockedEnvironment,
                                                                        almaKeysFetcher);
        var appender = LogRecorder.forClass(LibraryUserManagementHandler.class);
    ...
    public void shouldIgnoreUserAndLogProblemIfBaseBibliotekIsNotAvailable() throws IOException {
        ...
        libraryUserManagementHandler = new LibraryUserManagementHandler(s3Client,
                                                                        mockedEnvironment,
                                                                        almaKeysFetcher);
        final var appender = LogRecorder.forClass(HttpUrlConnectionBaseBibliotekApi.class);
        final Integer count = libraryUserManagementHandler.handleRequest(s3Event, CONTEXT);
        assertThat(count, is(0));
        assertThat(appender.asString(), containsString(LOG_MESSAGE_COMMUNICATION_PROBLEM));
    }
    ...
    public void shouldIgnoreUserAndLogProblemIfAlmaGetUserReturnsBadRequestWithUnhandledErrorCode()
        ...
        final var appender = LogRecorder.forClass(HttpUrlConnectionAlmaUserUpserter.class);
        final Integer count = libraryUserManagementHandler.handleRequest(s3Event, CONTEXT);
        assertThat(count, is(0));
        assertThat(appender.asString(), containsString(UNEXPECTED_RESPONSE_FETCHING_USER_LOG_MESSAGE_PREFIX));
    }
    ...
    public void shouldIgnoreUserAndLogProblemIfAlmaUpdateUserReturnsBadRequestWithUnhandledErrorCode()
        ...
        final Integer count = libraryUserManagementHandler.handleRequest(s3Event, CONTEXT);
        assertThat(count, is(0));
        assertThat(appender.asString(), containsString(
    ...
    public void shouldRedactSensitiveDataFromExceptionWhenAlmaCreateFail() throws IOException {
        ...
        assertThat(appender.asString(), not(containsString("<password>***masked***</password>")));
        assertThat(appender.asString(), containsString("<password>redacted</password>"));
    }
    ...
    void shouldReturnZeroAndLogWhyWhenAlmaApiKeyMapIsEmpty() throws IOException {
        ...
        assertThat(appender.asString(), containsString(SKIPPING_HANDLING_OF_REQUESTS));
    }
    ...
    void shouldLogErrorWhenSerializationThrowsException() throws IOException {
        ...
        try (var mockedSerializer = mockStatic(SerializerUtils.class)) {
            ...
            assertThat(count, is(equalTo(0)));
            assertThat(appender.asString(), containsString("Unknown exception when serializing user"));
        }
    }
